              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card shadow-lg">
                    <div class="card-header text-white bg-primary"> BLOOD REQUESTS
                      <a href="/admin/blood-request/create" class="btn btn-success btn-sm pull-right">ADD</a>
                    </div>
                    <div class="card-body">
                      @if(count($blood_requests)>0)
                      <table class="table table-striped table-responsive-sm table-responsive-md" w>
                        <thead>
                          <tr>
                            <th>#SN</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $blood_request->gender }}</td>
                            <td>{{ $blood_request->date_required }}</td>
                           
                            <td>{{ $blood_request->contact}}
                            </td>
                           
                            <td>{{ $blood_request->unit_of_blood}}</td>
                            <td>{{ $blood_request->hospital_address }}</td>
                            <td><img style ="width: 80px;height:60px" src="/storage/profile_pics/{{ $blood_request->profile_pic }}" alt="profile_pics"></td>
                            </td>
                            
                         
                            
                            <td>
                              <a href="/admin/blood-request/{{ $blood_request->id }}/edit" class="btn btn-primary btn-sm">EDIT</a>
                              
                            </td>
                            <td>
                              {!! Form::open(['action'=>['BloodRequestController@destroy',$blood_request->id],'method'=>'POST']) !!}
                      ...
                      @else
                      <h3><strong>There are no blood requests made</strong></h3>
                      @endif
