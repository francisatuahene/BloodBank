...
class BloodRequestController extends Controller
{
    ...
    public function index()
    {
        //
        $admins = Admin::all();
        $blood_requests = blood_request::all();
        return view('blood_request.view_blood_request')->with('blood_requests',$blood_requests)->with('admins',$admins);
    ...
    public function create()
    {
        ...
        $admins = Admin::all();
        return view('blood_request.add_blood_request')->with('admins',$admins);
    }
    ...
    public function store(Request $request)
    {
      ...
      return redirect('/admin/blood-request');
    }
    ...
    public function edit($id)
    {
        ...
        $admins = Admin::all();
        $blood_requests = blood_request::find($id);
        return view('blood_request.edit_blood_request')->with('blood_requests',$blood_requests)->with('admins',$admins);
    }
    ...
    public function destroy($id)
    {
        ...
        Storage::delete('public/profile_pics'.$blood_requests->profile_pic);
